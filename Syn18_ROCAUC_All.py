...
log_dir_path = "/n/groups/patel/adithya/Syn18_ROCAUC_Log_Dir_Maximal/"
...
def main():
    ...
    best_estimator_name = maximal_classifier.best_estimator
...
# Log best estimator details to the text log
    with open(LOG_FILE_PATH, 'a') as log_file:
        ...
        log_file.write(f"Best Parameters: {best_parameters}\n")
