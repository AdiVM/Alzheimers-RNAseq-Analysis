...
log_dir_path = "/n/groups/patel/adithya/Alz_Outputs/Final_Outputs/Cell_on_cell_genes_modules/"
...
def main():
    ...
    cols_to_drop = ['sample', 'cts_mmse30_lv', 'pmi', 'msex', 'broad.cell.type', 
                    'alzheimers_or_control', 'age_death', 'educ'] + apoe_genotype_columns
