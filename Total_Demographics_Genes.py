## This script is used to run AutoML on the combined gene expression and metadata data for the entire dataset.
...
log_dir_path = "/n/groups/patel/adithya/Alz_Outputs/Final_Outputs/Total_both_nopmi/"
...
def main():
    ...
    log_message = f"Processing {exp_type} data with cells using full integration of gene and metadata features"
